...
public class SootConfigure {
    public static void main(String[] args) {
        ...
        // Adding a Unit
        units.add(Jimple.v().newAssignStmt(arg, Jimple.v()
                .newStaticFieldRef(Scene.v().getField("<java.lang.System: java.io.PrintStream out>").makeRef())));

        // insert "tmpRef.println("Hello world!")"
        SootMethod toCall = Scene.v().getMethod("<java.io.PrintStream: void println(java.lang.String)>");
        Unit iftarget = Jimple.v().newInvokeStmt(
                Jimple.v().newVirtualInvokeExpr(tmpRef1, toCall.makeRef(), StringConstant.v("Hello world!")));
